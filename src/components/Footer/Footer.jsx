    ...
    return (
        <div className="">
                ...
                <div className="px-[10px] container mx-auto flex flex-wrap gap-y-4 justify-between items-center  ">
                    ...
                    <div className="flex justify-start gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-[#FFFFFFCC] text-xs font-semibold leading-normal">(Monday to Saturday, 8AM to 10PM and Sunday, 10AM to 7PM)</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-primary-color py-4 px-2">
                ...
                <div>
                    <p className="text-white text-[10px] font-medium leading-normal tracking-[0.2px] text-center">© 2023 Perfecto. All Rights Reserved.</p>
                </div>
            </div>
