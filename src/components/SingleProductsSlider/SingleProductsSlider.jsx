                                        ...
                                        sliderImages?.map((item, index) => (
                                            <div
                                                className={`  hover:cursor-pointer rounded ${
                                                    index === currentIndex ? "border border-[#5DC9F4] " : ""
                                                }`}
                                                key={index}
                                            >
                            ...
                            >
                                {sliderImages?.map((item, index) => (
                                    <div className="w-full" key={index}>
                                        <div
                                            className={` w-full h-[305px] ${windowWidth > 430 && "h-[330px]"} ${
                                                windowWidth > 450 && "h-[350px]"
                                            } xs:h-[362px] sm:h-[370px] md:h-[380px] lg:h-[370px] xl:h-[370px] 2xl:h-[372px] cursor-zoom-in relative overflow-hidden`}
                        ...
                        <div className="w-10/12">
                            <div className="">
                                <Slider
                                    ...
                                    slidesToShow={sliderImages?.length > 5 ? (windowWidth < 360 ? 3 : 5) : sliderImages?.length || 1}
                                    swipeToSlide={true}
                                    focusOnSelect={true}
                                    arrows={false}
                                    centerMode={true}
