...
const ProductDetails = () => {
    ...
    //         const availableShadesOnStock = item?.product_shades?.filter((shade) => shade?.stock !== null);
    ...
    //         const availableSizesOnStock = item?.product_sizes?.filter((size) => size?.stock !== null);
    //         const initialSelectedSizeId = availableSizesOnStock?.[0]?.size_id;
    //         if (initialSelectedSizeId) {
                                                        ...
                                                        <>
                                                            <p className="whitespace-nowrap text-[#000000CC] font-inter text-xs md:text-sm font-normal leading-normal">
                                                                ...
                                                                <Link to={`/product-filter?brand=${singleProduct?.data?.product?.brand_id}`}>
                                                                    <span className="text-black font-medium hover:cursor-pointer"> {singleProduct?.data?.product?.brand?.name}</span>
                                                                </Link>
                                                            </p>
                                ...
                                <div
                                                        ...
                                                        <div className="flex items-start gap-2">
                                                            ...
                                                            <div className="border h-24 overflow-hidden overflow-y-auto slim-scroll p-2 w-full flex gap-2 flex-wrap">
                                                                ...
                                                                {/* {singleProduct?.data?.product?.product_shades.map((shade, index) => <div className="w-7 h-7 rounded hover:cursor-pointer" key={index}><ImageURL image={shade?.image}/></div>)} */}

                                                                {/* {singleProduct?.data?.product?.product_shades.map((item, index) => (
                                                                    <div
                                                                        className="w-7 h-7 rounded hover:cursor-pointer overflow-hidden relative"
                                                                        key={index}
                                                                    >
                                                                        <div
                                                                            className={`${
                                                                                ...
                                                                                <Tooltip placement="top" title={"Stock Out"}>
                                                                                    <div
                                                                                        className={` rounded hover:cursor-pointer overflow-hidden relative ${
                                                                                            product?.shade?.id == selectedShade?.shade_id
                                                ...
                                                absolute top-0 left-0 w-full h-full flex justify-center items-center`}
                                                                                ...
                                                                                >
                                                                                    <div
                                                                                        className={`${
                                                                                            product?.shade?.id == selectedShade?.shade_id ? "block" : "hidden"
                                                                                        } absolute top-0 left-0 w-full h-full flex justify-center items-center`}
                                                                                    >
                                                        ...
                                                        <div className="flex items-center justify-between mb-1">
                                                            <div className="relative">
                                                                ...
                                                                >
                                                                    ...
                                                                    <>
                                                                        {Array?.isArray(dropDownItemsForSize) && dropDownItemsForSize?.length > 0 && (
                                                                            <Dropdown
                                                                                overlayStyle={{minWidth: "200px"}}
                                                                                placement="bottomLeft"
                                                                                trigger={["click"]}
                                                    ...
                                                    <div className="flex items-center gap-2 md:gap-5">
                                                        ...
                                                        <Button
                                                            ...
                                                            className={`rounded font-semibold  text-xs px-2 py-1 xs:py-2 xs:px-5 md:py-[8px] ${
                                                                wishListItemIsExist == null || "bg-primary-color"
                                                            }`}
                                                            variant="bordered"
                                                        >
