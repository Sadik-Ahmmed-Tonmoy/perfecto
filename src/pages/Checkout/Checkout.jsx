...
const Checkout = () => {
    ...
    const {cartData, cartIsLoading, cartRefetch} = useCartData();
        ...
        if (selectedCity?.selected_item_id == undefined) {
            ...
            if (cartData?.status) {
                ...
                const fullOrderData = {
                    ...
                    shipping_charge: shippingMethod == "insideDhaka" ? shippingChargeQuery?.data?.inside_city : shippingChargeQuery?.data?.outside_city,
                ...
                <div className="w-full md:w-6/12 md:border-e-[0.5px] border-[#ECECEC] py-4 px-2 xs:py-6 xs:px-5 lg:py-[30px] lg:px-[32px]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                            ...
                            <div className="mb-5 relative">
                                ...
                                {defaultAddressFromDB?.city_id ? "" :
                                    <DropDownListAndSelect options={cityList} placeholder={"Select City"} setSelectedValue={setSelectedCity} setRemoveValue={setSelectedZone}/>}
                                {defaultAddressFromDB?.city_id && (
                            ...
                            <div className="mb-5 relative">
                                ...
                                {defaultAddressFromDB?.zone_id ? "" :
                                    <DropDownListAndSelect options={zoneList} placeholder={"Please select the city to choose the zone."} setSelectedValue={setSelectedZone}
                    ...
                    <div>
                        ...
                        >
                            <div className="relative flex items-center">
                                <input type="checkbox"
                                       className={`rounded-full h-4 w-4 ${shippingMethod == "insideDhaka" ? "bg-[#5DC9F4] text-white" : "bg-white"} border border-[#0094CF] appearance-none`}/>
                                <BsCheck size={16} className="absolute top-0 text-white"/>
                            </div>
                            <p className="text-black font-inter text-sm font-semibold leading-normal">
                                Inside Dhaka
                                <span className="ps-1 whitespace-nowrap">(Delivery charge: ৳ {parseInt(shippingChargeQuery?.data?.inside_city).toFixed(0)})</span>
                            </p>
                        </label>
                        <label
                            className="flex items-center hover:cursor-pointer gap-3 text-[#252728] font-inter text-sm font-normal leading-normal w-fit h-min mb-5"
                        ...
                        <div className="bg-[#fff] rounded-4px] py-2 px-2 xs:py-3 xs:px-3 lg:py-5 lg:px-6 mb-4 rounded-[4px]">
                            ...
                            <div className="border-b-[0.3px]">
                                ...
                                <div className="flex justify-between my-1 xs:my-3">
                                    ...
                                    <p className="text-black text-right font-inter text-sm md:text-base font-semibold leading-normal">
                                        {shippingMethod == "insideDhaka" ? shippingChargeQuery?.data?.inside_city : shippingChargeQuery?.data?.outside_city}
                                    </p>
                                </div>
                                ...
                                <label className="flex items-start gap-2 py-3 hover:cursor-not-allowed">
                                    ...
                                    <div>
                                        <div className="flex items-center flex-wrap">
                                            ...
                                            <p className="text-[10px] xs:text-sm xs:ms-1 whitespace-nowrap text-red-400">(COD is available for Dhaka only)</p>
                                        </div>
